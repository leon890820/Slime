Shader "URP/Instanced/ParticleDebug3DLitIndirect"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            StructuredBuffer<float3x3> Covariance;
            #endif
            ...
            Varyings vert (Attributes IN)
            {
                ...
                float3x3 cov = Covariance[unity_InstanceID];
                posWS = p + (mul(cov, IN.positionOS.xyz) * s);
                #else
