...
public static class ComputeHelper
{
    ...
    public static void SetParameter<T>(this ComputeShader compute, string name, T value) {
        if (typeof(T) == typeof(int))
            compute.SetInt(name, (int)(object)value);
        else if (typeof(T) == typeof(float))
            compute.SetFloat(name, (float)(object)value);
        else if (typeof(T) == typeof(bool))
            compute.SetBool(name, (bool)(object)value);
        else if (typeof(T) == typeof(Vector2))
            compute.SetVector(name, (Vector2)(object)value);
        else if (typeof(T) == typeof(Vector3))
            compute.SetVector(name, (Vector3)(object)value);
        else if (typeof(T) == typeof(Vector4))
            compute.SetVector(name, (Vector4)(object)value);
        else if (typeof(T) == typeof(Matrix4x4))
            compute.SetMatrix(name, (Matrix4x4)(object)value);
        else
            throw new System.NotSupportedException(
                $"ComputeHelper.SetParameter<{typeof(T).Name}> is not supported"
            );
    }
